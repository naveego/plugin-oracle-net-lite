...
using PluginOracleNetLite.API.Discover;
using PluginOracleNetLite.API.Factory;
using PluginOracleNetLite.API.Read;
using PluginOracleNetLite.API.Replication;
using PluginOracleNetLite.API.Write;
using PluginOracleNetLite.DataContracts;
using PluginOracleNetLite.Helper;

namespace PluginOracleNetLite.Plugin
{
    public class Plugin : Publisher.PublisherBase
    {
            ...
            ServerCallContext context)
        {
            ...
            if (request.Mode == DiscoverSchemasRequest.Types.Mode.All)
            {
                ...
                try
                {
                    Logger.Info($"Plugin does not support automated discovery.");
